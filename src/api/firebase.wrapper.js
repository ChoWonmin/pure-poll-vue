  ...
  genData: path => {
    ...
    for (let i=0; i<200; i++) {
      const obj = {
        ...
        resLocation: '서울특별시',
        poll: {
          1: parseInt(Math.random()*5 + 1),
          2: parseInt(Math.random()*4 + 1),
          3: parseInt(Math.random()*5 + 1),
          4: parseInt(Math.random()*4 + 1),
          5: parseInt(Math.random()*3 + 1),
          6: parseInt(Math.random()*6 + 1),
          7: parseInt(Math.random()*6 + 1),
          8: parseInt(Math.random()*6 + 1)
        }
      };
